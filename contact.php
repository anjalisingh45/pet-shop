...
<body>
    ...
    <div class="container-fluid pt-5">
        <div class="container">
            ...
            <div class="row g-5">
                <div class="col-lg-7">
                    <form role="form" action="insert_cont.php" method="post">
                        <div class="row g-3">
                            <div class="col-12">
                                <input type="text" name="a" class="form-control bg-light border-0 px-4" placeholder="Your Name" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <input type="email"  name="b" class="form-control bg-light border-0 px-4" placeholder="Your Email" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <input type="text"  name="c" class="form-control bg-light border-0 px-4" placeholder="Subject" style="height: 55px;">
                            </div>
                            <div class="col-12">
                                <textarea  name="d" class="form-control bg-light border-0 px-4 py-3" rows="8" placeholder="Message"></textarea>
                            </div>
                            <div class="col-12">
                    ...
                    <div class="bg-light mb-5 p-5">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            ...
                            <div class="text-start">
                                ...
                                <span>pawspire@example.com</span>
                            </div>
                        </div>
